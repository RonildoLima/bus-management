...
export function TutorialModal({ isOpen, onClose, darkMode = false }: TutorialModalProps) {
  if (!isOpen) return null;

  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
      <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-lg max-w-4xl w-full max-h-[90vh] flex flex-col`}>
        <div className={`flex justify-between items-center p-6 border-b sticky top-0 ${darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'} rounded-t-lg z-10`}>
          <h2 className={`text-2xl font-bold ${darkMode ? 'text-gray-100' : 'text-gray-800'}`}>Tutorial de Utilização</h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>OBSERVAÇÕES IMPORTANTES</h3>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 1: Copiar e Colar a Lista</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 2: Definir a Capacidade do Ônibus</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 3: Selecionar o Motorista</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 4: Selecionar as Universidades</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 5: Preenchimento Automático de Vagas</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 6: Preenchimento Manual de Vagas</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 7: Excluir Alunos da Lista</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
            ...
            <section>
              <h3 className={`text-xl font-semibold ${darkMode ? 'text-gray-200' : 'text-gray-700'} mb-3`}>Passo 8: Copiar Listas</h3>
              <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-600'}`}>
